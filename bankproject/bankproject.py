"""
Python banka kartı şifre ve kart alımı ve sisteme girerek bilgileri görme programı ...
Banka Kart Numarası Anatomisi : 5304 4642 1234 5678

1- ilk sayı kartın türünü belirtir(1,2=uçuş kartları ; 3=gezi turizm kartları ; 4,5=bankacılık hesap kartları ;6=ticari kartlar ;7= petrol şirketleri;8= telekominikasyon şirketleri;9=ulusal görev)
2- ilk 6 hane banka kimlik numarası
3- 7-15 haneler hesap kimlik numarası
4- son hane kontrol numarası
"""
import time
import random
import json
